...
export default async function handler(req, res) {
  ...
  try {
    ...
    const initialPrompt = `
      ...
      - "initialFindings": (String) Your key initial observations, insights, or hypotheses related to "${topicDisplayName}" based on the provided data summary. This string should be formatted with HTML tags for paragraphs (e.g., "<p>Insight 1.</p><p>Insight 2.</p>"). IMPORTANT: The entire string value for "initialFindings" must be a valid JSON string. This means any double quotes (") that are part of the text content or attributes within the HTML MUST be escaped as \\". For example, if a paragraph is '<p>He said "More data!".</p>', it should be represented in the string as "<p>He said \\"More data!\\".</p>".
      - "thoughtProcess": (String) Briefly explain the steps or reasoning you took to arrive at these initialFindings. Mention which parts of the data summary were most relevant. This string should be formatted as an HTML unordered list (e.g., "<ul><li>Step one explaining \\"why\\".</li><li>Step two.</li><li>Step three.</li></ul>") containing exactly 3 bullet points. IMPORTANT: The entire string value for "thoughtProcess" must be a valid JSON string. This means any double quotes (") that are part of the text content or attributes within the HTML list items MUST be escaped as \\".
